...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "group rounded-3xl bg-neutral-200 p-2 no-underline shadow-sm transition-colors dark:bg-neutral-800",
...
>(({ className, alt, src, loading, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative mb-6 h-47.5 w-full rounded-[20px]",
        "shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset,0px_0px_1px_0px_rgba(28,27,26,0.5)]",
        "dark:shadow-[0_1px_0_0_rgba(255,255,255,0.03)_inset,0_0_0_1px_rgba(255,255,255,0.03)_inset,0_0_0_1px_rgba(0,0,0,0.1),0_2px_2px_0_rgba(0,0,0,0.1),0_4px_4px_0_rgba(0,0,0,0.1),0_8px_8px_0_rgba(0,0,0,0.1)]",
        className
      )}
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "mt-2 px-1 text-lg font-semibold leading-tight text-black dark:text-gray-300 transition-colors",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "px-1 pb-2 mt-4 text-sm text-black transition-colors dark:text-neutral-400",
      className
    )}
    {...props}
  />
